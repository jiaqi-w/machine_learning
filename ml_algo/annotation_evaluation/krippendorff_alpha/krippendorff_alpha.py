...
if __name__ == '__main__': 
    ...
    label_fields = get_data_from_MT.get_label_names("Answer.P{}Q2Answer", num_annotate_each_line)
    worker_id_field = 'WorkerId'
    num_annotate_each_text = 3  # repeaet 3 times
    array = get_data_from_MT.get_data("./data", label_fields, worker_id_field, num_annotate_each_text)
